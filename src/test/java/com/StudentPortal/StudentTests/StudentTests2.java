...
public class StudentTests2 extends AutomationTestPlan {
	
	public StudentTests2() {
...
//Test 08 ---Ledger Adjust Transaction-Void
		@Test(enabled = true, dataProvider = "getData", priority = 9,alwaysRun = true, description ="LedgerAdjustTransactionVoid", testName = "LedgerAdjustTransactionVoid")
...
//Test 09 ---Ledger Card - Print
		@Test(enabled = true, dataProvider = "getData", priority = 10,alwaysRun = true, description ="Ledger Card - Print", testName = "Ledger Card - Print")
...
//Test 10 ---Ledger Card - Print Detail
		@Test(enabled = true, dataProvider = "getData", priority = 11,alwaysRun = true, description ="Ledger Card - Print Detail", testName = "Ledger Card - Print Detail")
...
//Test 11 ---Configuration of manual or automated apply payment
		@Test(enabled = true, dataProvider = "getData", priority = 12,alwaysRun = true, description ="Configuration of manual or automated apply payment", testName = "Configuration of manual or automated apply payment")
...
//Test 12 ---Ledger Card - Apply Payment or Credits
		@Test(enabled = true, dataProvider = "getData", priority = 13,alwaysRun = true, description ="Ledger Card - Apply Payment or Credits", testName = "Ledger Card - Apply Payment or Credits")
...
//Test 13 ---Ledger Card - Adjust Transaction - Delete
		@Test(enabled = true, dataProvider = "getData", priority = 8,alwaysRun = true, description ="Ledger Card - Adjust Transaction - Delete", testName = "Ledger Card - Adjust Transaction - Delete")
...
//Test 16
		@Test(enabled = true, dataProvider = "getData", priority = 16,alwaysRun = true, description ="Ledger Card - Print Detail", testName = "CreateFundSource")
...
//Test 17 ---Ledger Card - Schedule a Stipend
		@Test(enabled = true, dataProvider = "getData", priority = 17,alwaysRun = true, description ="Ledger Card - Schedule a Stipend", testName = "Ledger Card - Schedule a Stipend")
...
//Test 18 ---Process Scheduled Refunds
		@Test(enabled = true, dataProvider = "getData", priority = 18,alwaysRun = true, description ="Process Scheduled Refunds", testName = "Process Scheduled Refunds")
...
//Test 19 ---Process Scheduled Stipends
		@Test(enabled = true, dataProvider = "getData", priority = 19,alwaysRun = true, description ="Process Scheduled Stipends", testName = "Process Scheduled Stipends")
...
//Test 20 ---School Fields - Confirm new information can be added to field for Student Accounts
		@Test(enabled = true, dataProvider = "getData", priority = 20,alwaysRun = true, description ="School Fields - Confirm new information can be added to field for Student Accounts", testName = "School Fields - Confirm new information can be added to field for Student Accounts")
...
//Test 21 ---School Fields - Confirm new information can be added to field for Admissions
		@Test(enabled = true, dataProvider = "getData", priority = 21,alwaysRun = true, description ="School Fields - Confirm new information can be added to field for Admissions", testName = "School Fields - Confirm new information can be added to field for Admissions")
...
//Test 22 ---School Fields - Confirm new information can be added to field for Student Services
		@Test(enabled = true, dataProvider = "getData", priority = 22,alwaysRun = true, description ="School Fields - Confirm new information can be added to field for Student Services", testName = "School Fields - Confirm new information can be added to field for Student Services")
...
//Test 23 ---School Fields - Confirm new information can be added to field for Career Services
		@Test(enabled = true, dataProvider = "getData", priority = 23,alwaysRun = true, description ="School Fields - Confirm new information can be added to field for Career Services", testName = "School Fields - Confirm new information can be added to field for Career Services")
...
//Test 24 ---School Fields - Confirm new information can be added to field for Housing School Fields
		@Test(enabled = true, dataProvider = "getData", priority = 24,alwaysRun = true, description ="School Fields - Confirm new information can be added to field for Housing School Fields", testName = "School Fields - Confirm new information can be added to field for Housing School Fields")
...
//Test 25 ---Configure Documents associated with the FA module
		@Test(enabled = true, dataProvider = "getData", priority = 25,alwaysRun = true, description ="Configure Documents associated with the FA module", testName = "Configure Documents associated with the FA module")
...
//Test 26 ---Configure Document Schedules
		@Test(enabled = true, dataProvider = "getData", priority = 26,alwaysRun = true, description ="Configure Document Schedules", testName = "Configure Document Schedules")
...
//Test 27 ---Ability to add documents to individual Student record from the Financial Aid module
		@Test(enabled = true, dataProvider = "getData", priority = 27,alwaysRun = true, description ="Ability to add documents to individual Student record from the Financial Aid module", testName = "Ability to add documents to individual Student record from the Financial Aid module")
...
//Test 28 ---Ability to add document lists to individual Student record from the Financial Aid module
		@Test(enabled = true, dataProvider = "getData", priority = 28,alwaysRun = true, description ="Ability to add document lists to individual Student record from the Financial Aid module", testName = "Ability to add document lists to individual Student record from the Financial Aid module")
...
//Test 29 ---Configure Document Policies
		@Test(enabled = true, dataProvider = "getData", priority = 29,alwaysRun = true, description ="Configure Document Policies", testName = "Configure Document Policies")
...
//Test 30 ---Ledger Card - Print Summary
		@Test(enabled = true, dataProvider = "getData", priority = 30,alwaysRun = true, description ="Ledger Card - Print Detail", testName = "TC940_3LedgerCardPrintSummary")
...
//Test 31 ---Letters should be created for employers
		@Test(enabled = true, dataProvider = "getData", priority = 31,alwaysRun = true, description ="Ledger Card - Print Detail", testName = "Letters should be created for employers")
...
//Test 32 ---Letters configured for employers should be available for printing
		@Test(enabled = true, dataProvider = "getData", priority = 32,alwaysRun = true, description ="Ledger Card - Print Detail", testName = "Letters configured for employers should be available for printing")
...
//Test 33		
		@Test(enabled = true, dataProvider = "getData", priority = 33,alwaysRun = true, description ="SubsidiaryLedgerAdjustTransactionReturnedCheck", testName = "LedgerCardAdjustTransactionReturnedCheck")
				@TestCaseFields(testCaseName = "LedgerCardAdjustTransactionReturnedCheck")
				public void TC937LedgerCardAdjustTransactionReturnedCheck(StringHash data) throws Exception {
				StudentLoginTest1Flow.AdjustingLedgerTransactionReturnCheck(data);
		}
//Test 34		
		@Test(enabled = true, dataProvider = "getData", priority = 34,alwaysRun = true, description ="AddSchoolDefinedFieldsNew", testName = "AddSchoolDefinedFieldsNew")
				@TestCaseFields(testCaseName = "AddSchoolDefinedFieldsNew")
				public void TC1957_AddSchoolDefinedFieldsNew(StringHash data) throws Exception {
				StudentLoginTest1Flow.SchoolFieldCreation(data);
				}
//Test 35		
		@Test(enabled = true, dataProvider = "getData", priority = 35,alwaysRun = true, description ="HousingAddHousingApplication", testName = "HousingAddHousingApplication")
				@TestCaseFields(testCaseName = "HousingAddHousingApplication")
				public void TC1779_HousingAddHousingApplication(StringHash data) throws Exception {
				StudentLoginTest1Flow.AddingHousingApplication(data);
				}
//Test 36
		@Test(enabled = true, dataProvider = "getData", priority = 36,alwaysRun = true, description ="SubsidiaryLedgerAdjustTransactionReturnedCheck", testName = "SubsidiaryLedgerAdjustTransactionReturnedCheck")
				@TestCaseFields(testCaseName = "SubsidiaryLedgerAdjustTransactionReturnedCheck")
				public void TC933SubsidiaryLedgerAdjustTransactionReturnedCheck(StringHash data) throws Exception {
				StudentLoginTest1Flow.AdjustingSubTransactionReturnCheck(data);
}
	@DataProvider
