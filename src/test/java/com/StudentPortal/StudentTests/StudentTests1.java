...
public class StudentTests1 extends AutomationTestPlan {

	public StudentTests1() {
...
//Test 20
	...
	public void TC875_VerifyappropriateconfigurationenablestheabilitytosendSMStostudents(StringHash data)
			throws Exception {
...
//Test 36
	@Test(enabled = true, dataProvider = "getData", priority = 27, alwaysRun = true, description = "Billable Services- Confirm new information can be added to field(s)", testName = "Billable Services- Confirm new information can be added to field(s)")
	@TestCaseFields(testCaseName = "Billable Services- Confirm new information can be added to field(s)")
	public void TC1755_BillableServicesConfirmnewinformationcanbeaddedtofields(StringHash data) throws Exception {

		StudentFlows.AddBillableServices(data);
	}

//Test 37
	@Test(enabled = true, dataProvider = "getData", priority = 28, alwaysRun = true, description = "Athletics- Confirm new information can be added to field(s)", testName = "Athletics- Confirm new information can be added to field(s)")
	@TestCaseFields(testCaseName = "Athletics- Confirm new information can be added to field(s)")
	public void TC1757_AthleticsConfirmnewinformationcanbeaddedtofields(StringHash data) throws Exception {

		StudentFlows.AddAthletics(data);
	}

//Test 38
	@Test(enabled = true, dataProvider = "getData", priority = 29, alwaysRun = true, description = "Accomodations- Confirm new information can be added to field(s)", testName = "Accomodations- Confirm new information can be added to field(s)")
	@TestCaseFields(testCaseName = "Accomodations- Confirm new information can be added to field(s)")
	public void TC1759_AccomodationsConfirmnewinformationcanbeaddedtofields(StringHash data) throws Exception {

		StudentFlows.AddAccomodations(data);
